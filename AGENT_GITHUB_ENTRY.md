...
- Forgetting `--known-character-compounds --known-character-compound-limit 600` for Marcel personalized manuscripts that use the high-frequency character-compound layer.
