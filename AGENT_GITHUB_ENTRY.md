...
| What should external writer agents download for quick vocabulary preflight? | `docs/external-agent-vocabulary.md`, `data/external_agent_vocab/high_frequency_characters_1000.txt`, `data/external_agent_vocab/known_words_minus_character_compounds.txt`, `data/external_agent_vocab/master_stretch_words_non_core.txt`, `data/external_agent_vocab/metadata.json` |
...
- Forgetting `--known-character-compounds --known-character-compound-limit 1000` for Marcel personalized manuscripts that use the high-frequency character-compound layer.
