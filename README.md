...
The 林安 series currently includes `manuscripts/shanghai-rain-gate-crime/` (`上海雨票案`), `manuscripts/shanghai-spirit-lamp-case/` (`上海灵灯案`), `manuscripts/shanghai-shadow-bridge-case/` (`上海影子桥案`), and `manuscripts/shanghai-midnight-ringtone-case/` (`上海零点铃声案`). Series continuity for its journalist protagonist lives in `series/an-lin/`.
