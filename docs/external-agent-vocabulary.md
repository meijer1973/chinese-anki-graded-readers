...
1. `data/external_agent_vocab/high_frequency_characters_500.txt`
...
2. Check whether every Hanzi character in the token appears in `high_frequency_characters_500.txt`. If yes, classify the token as `high_frequency_character_compound`.
