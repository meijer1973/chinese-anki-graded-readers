...
4. Literary critic writes `literary_critic_report.md`.
5. Normal reader writes `normal_reader_report.md`.
6. Lead reviewer writes `lead_quality_decision.md`.
