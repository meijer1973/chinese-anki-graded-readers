...
- learner-profile high-frequency character compounds, such as Marcel's top 1000 ranked characters in `data/learner_profiles/marcel/high_frequency_characters.txt`
...
1. `high_frequency_characters_1000.txt`
...
- `data/learner_profiles/marcel/high_frequency_characters.txt` contains Marcel's ranked known-character source for the optional `--known-character-compounds` layer; current default limit is 1000.
- `data/external_agent_vocab/` contains the generated compact three-file vocabulary bundle for remote Marcel-personalized drafting: top-1000 high-frequency characters, known words with character-compound-covered terms removed, and a master non-core stretch list.
...
For Marcel personalized mode, add `--personal-known data/learner_profiles/marcel/personal_known_words.txt --known-character-compounds --known-character-compound-limit 1000` to validation, quality-gate, report-generation, and EPUB commands.
