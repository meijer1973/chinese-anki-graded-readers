# Research Agent Map - Chinese Anki, Independent Language Starters, And Graded Readers
...
- how active known words are derived from the graded-reader ranked word source
...
- Remote Marcel-personalized writer agents can use the compact three-file vocabulary bundle in `data/external_agent_vocab/` for first-pass screening: check `high_frequency_characters_2100.txt` first, then `known_words_minus_character_compounds.txt`, then `master_stretch_words_non_core.txt`.
...
```json
{
  "entry_points": [
    ...
    "data/external_agent_vocab/high_frequency_characters_2100.txt",
...
- https://raw.githubusercontent.com/meijer1973/chinese-anki-graded-readers/main/data/external_agent_vocab/high_frequency_characters_2100.txt
...
```json
{
  ...
  "graded_reader_frequency_source": "High frequency words 0-10000.txt",
  ...
  "external_agent_high_frequency_characters": "data/external_agent_vocab/high_frequency_characters_2100.txt",
  ...
  "business_economics_pack": "data/stretch_packs/business_economics_150.txt",
...
| Download compact external-agent vocabulary | `docs/external-agent-vocabulary.md`, `data/external_agent_vocab/high_frequency_characters_2100.txt`, `data/external_agent_vocab/known_words_minus_character_compounds.txt`, `data/external_agent_vocab/master_stretch_words_non_core.txt` |
