...
- Stay within the minimum-difficulty gate: no more than 95% of tokens should be made only from the first 500 ranked high-frequency characters. As a soft target, use some upper-50% active known words and some character compounds requiring upper-50% enabled character-compound characters when they fit the scene.
