...
class FakeAnki:
    def __init__(self) -> None:
        ...
        self.decks = {"Default": 1}
        self.deck_config_ids = {"Default": 1}
        self.configs = {
            1: {
                "id": 1,
                "name": "Default",
    ...
    def add_incompatible_hindi_note(self) -> None:
        self.decks["Hindi"] = self.next_deck_id
        self.next_deck_id += 1
        self.deck_config_ids["Hindi"] = 1
        self.models["Basic"] = {
            "fields": ["Front", "Back"],
